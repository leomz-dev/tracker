...
import { CalendarDays, ChartColumn, ListTodo, Settings as SettingsIcon } from 'lucide-react';
...
const MobileNav = ({ activePage, onNavigate }) => (
  <nav
    className="fixed inset-x-0 bottom-0 z-40 flex border-t border-border bg-card/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-md sm:hidden"
    role="navigation"
